...
const Navbar = () => {
    ...
    return (
        <div className='max-w-[1100px] mx-auto rounded-b-lg bg-[#1b1b1b] z-10 fixed top-0 left-0 right-0 h-[70px] item-flexed md:gap-36 gap-20 motion-safe:animate-fadeIn'>
            <div className='z-10'>
                <img src={logo} alt="logo" className='md:w-60' />
            </div>
            <div className="hidden md:block">
                <ul className="item-flexed gap-[50px] text-white">
                    <li>Home</li>
                    <li>Case Studies</li>
                    <li>Testimonials</li>
                    <li>Recent Work</li>
